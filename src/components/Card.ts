export class Card{
    constructor(
        public logo: string = "./imgs/logo.jpg",
        public company: string = "Amazon",
        public days: string = "5 days ago",
        public title: string = "Senior UI/UX Designer",
        public part: string = "Part Time",
        public level: string = "Senior level",
        public price: string = "$120/hr",
        public ubication: string = "San Francisco, CA"
    ){
        console.log('card');
    }
